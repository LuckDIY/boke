...
<#--							<a href="${context!}/admin/index.ftl#/dashboard" target="_blank">管理中心</a>-->
<#--							<a href="${context!}/admin/index.ftl#/posts/write" target="_blank">撰写文章</a>-->
<#--							<a href="${context!}/admin/index.ftl#/user/profile" target="_blank">个人资料</a>-->
<#--						</div>-->
					</div>
				</div>
